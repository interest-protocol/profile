...
public fun config_plugin_mut<T: drop, PluginConfig: store>(config: &mut Config, _: T): &mut PluginConfig {
...
public fun profile_plugin_mut<T: drop, ProfilePlugin: store>(profile: &mut Profile, _: T): &mut ProfilePlugin {
